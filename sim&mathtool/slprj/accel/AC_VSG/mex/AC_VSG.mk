...
MODEL                   = AC_VSG
MODULES                 = AC_VSG_acc.c AC_VSG_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\AC_VSG_acc.mexw64
MAKEFILE                = AC_VSG.mk
MATLAB_ROOT             = D:\Program Files\MATLAB\R2022b
ALT_MATLAB_ROOT         = D:\PROGRA~1\MATLAB\R2022b
START_DIR               = E:\Embedded Full ENG Path\VSG_Inverter\sim&mathtool
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 32
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:AC_VSG_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = AC_VSG_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = AC_VSG_ref.rsp
COMPILER_COMMAND_FILE     = AC_VSG_comp.rsp
...
AC_VSG_acc.obj : $(START_DIR)\slprj\accel\AC_VSG\AC_VSG_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AC_VSG\AC_VSG_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AC_VSG\AC_VSG_acc.c

AC_VSG_acc_data.obj : $(START_DIR)\slprj\accel\AC_VSG\AC_VSG_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AC_VSG\AC_VSG_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AC_VSG\AC_VSG_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\AC_VSG\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AC_VSG\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AC_VSG\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\AC_VSG\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AC_VSG\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AC_VSG\rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\AC_VSG\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AC_VSG\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AC_VSG\rt_nonfinite.c
